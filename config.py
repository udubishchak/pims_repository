...
модулей. Значения синхронизированы с финальной версией ноутбука
(`код_вкр_финальный.ipynb`) и текстом ВКР.
"""
...
# Соответствуют BASE_PARAMS из ноутбука (без явной регуляризации —
# регуляризация выполняется через early_stopping и max_depth).
# ──────────────────────────────────────────────────────────────────────
LGBM_PARAMS = dict(
    n_estimators=400,
    learning_rate=0.05,
...
# (см. таблицу 3.6б ВКР, замечание №7 руководителя).
...
# ──────────────────────────────────────────────────────────────────────
# 6. ПАРАМЕТРЫ ЭКОНОМИЧЕСКОЙ МОДЕЛИ (см. раздел 3.6 ВКР, замечание №3)
